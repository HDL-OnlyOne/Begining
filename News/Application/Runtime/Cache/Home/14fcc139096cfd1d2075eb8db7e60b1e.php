...
<header id="header">
  ...
  <div class="right-content">
    <ul>
      <?php if(is_array($sm_title)): $k = 0; $__LIST__ = $sm_title;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="num<?php echo ($k); ?> curr">
  ...
  <?php if(is_array($adv)): $k = 0; $__LIST__ = $adv;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="right-hot">
